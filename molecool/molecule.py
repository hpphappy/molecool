...
def build_bond_list(coordinates, max_bond=1.5, min_bond=0):
    ...
    coordinates : np.ndarray
        The coordinates of the num_atoms.
    max_bond : float (optional)
        The maximum distance for two atoms to be considered bonded. The defult is 1.5.
    min_bond : float (optional)
        The minimum distance for two atoms to be considered bonded. The defult is 0.
