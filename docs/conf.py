...
project = 'molecool'
copyright = ("2020, Panpan Huang. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A python package for analyzing and visualizing pdb and xyz files. For MolSSI May webninar series.',
     'Miscellaneous'),
]
